      ...
      <div className="max-w-2xl mx-auto">
        <div className="flex items-center justify-between gap-4 mb-8">
          <div>
            ...
            <h1 className="a-text text-4xl font-black tracking-tight mt-1">My crew</h1>
          </div>
        ...
        {isFacilitator ? (
          ...
          <div className="px-4 py-6 rounded-2xl a-surface-2 border a-border text-center">
            <div className="text-4xl mb-3">🎪</div>
            <p className="a-text font-bold">You're on someone else's crew</p>
            <p className="a-text-2 text-sm mt-1">
              You're helping {account?.display_name ? <b className="a-text-2">{account.display_name}</b> : 'an organiser'} run their
          ...
          <div className="flex flex-col gap-8">
            ...
            {isOwner && (
              <button onClick={() => navigate('/bingo-dash/accounts')}
                className="text-sm a-text-3 hover:a-text transition-colors text-left">
